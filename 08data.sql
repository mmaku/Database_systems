...
INSERT INTO nations (name, short) VALUES ('The United states OF America','USA');
...
INSERT INTO nations (name, short) VALUES ('CZECH REPUBLIC', 'RUS');
...
INSERT INTO homologations (id_venue,discipline) VALUES (1,'TL');
...
INSERT INTO athletes (f_name, l_name, b_date, active, nation, club, sector) VALUES ('Rune','Velta','1989-07-19', TRUE, 'NOR','Lommedalen IL');
...
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Aleksander','Maze','1970-11-11','AUT','JP');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Marian','Winski','1976-03-06','POL','JP');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Jan','Maroszek','1980-12-15','POL','JP');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Anita','Randolle','1977-01-01','AUT','JP');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Ole','Ingvaldsen','1968-09-11','NOR','AL');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Magnus','Cologna','1972-09-18','SWE','AL');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Martin','Stock','1980-06-19','GER','JP');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Mikolaj','Razek','1983-10-25','CZE','AL');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Jarko','Maninen','1979-09-09','FIN','AL');
INSERT INTO referees (f_name,l_name,b_date,active,nation,sector) VALUES ('Pablo','Gunizo','1985-05-17','ITA','JP');
...
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (6,'2015-02-01','AL','GS',5,FALSE,TRUE);
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (7,'2015-01-30','AL','DH',6,FALSE,FALSE);
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (8,'2015-01-27','AL','SL',9,FALSE,TRUE);
...
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (1,'2015-01-31','JP','LH',10,FALSE,TRUE);
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (2,'2015-01-29','JP','LH',,FALSE,TRUE);
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (3,'2015-01-20','JP','FH',FALSE,TRUE);
INSERT INTO calendar(id_venue,c_date,sector,discipline,id_referee,counted,world_cup) VALUES (4,'2015-01-15','JP','NH',FALSE,TRUE);
...
--insertowaæ do rankingów jakieœ randomowe punkty, czy obliczy to f-cja jakas?
